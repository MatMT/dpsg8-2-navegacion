...
import type { BottomTabScreenProps } from '@react-navigation/bottom-tabs'; // Para ejercicio #2
...
const styles = StyleSheet.create({
  container: { alignItems: 'center', justifyContent: 'flex-start', paddingBottom: 20 },
  ...
  bannerButton: { backgroundColor: '#ffff00', fontSize: 16, color: '#000000' },
  featured: { padding: 20 },
